            ...
            try {
                ...
                try {
                    ...
                    for (int i = 0; i < tempArray.length; i++) {
                        ...
                        //System.out.println(tempArray3[0]);
                        if(tempArray3[0]!=0)
                        {
                    ...
                    System.out.println("REAL MESSAGE IS" + realMessage);

                    recievedMessage = realMessage;

                    System.out.println("Updated received message:" + recievedMessage);

                    String readMessage = ((byte[]) newMessage.obj).toString();                                                                // msg.arg1 = bytes from connect thread
                    ...
                    // break;
                    System.out.println("Error recieving data");
                }
                // }
